...
[![Build Status](https://travis-ci.org/waynehoover/s3_form_for.png)](https://travis-ci.org/waynehoover/s3_form_for)
...
**config/initializers/s3_form_for.rb**
```ruby
...
**application.css**
```css
//= require s3_form_for_progress_bars
```
...
Feel free to override the styling for the progress bars in s3_form_for_progress_bars.css, look at the source for inspiration.
...
To do this remove `s3_form_for` from your application.js and include the necessary jquery-file-upload scripts in your asset pipeline (they are included in this gem automatically):
```cofeescript
#= require jquery-fileupload/basic
#= require jquery-fileupload/vendor/tmpl
```
Use the javascript in `s3_form_for` as a guide.
...
```
  $ rake s3_form_for:clean_remote_uploads
...
**config/initalizers/s3_form_for.rb**
```ruby
S3DirectUpload.config do |c|
  # ...
